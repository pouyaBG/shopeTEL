...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <nav className="sticky bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.05)] z-[100]">
          ...
          return (
            <button
              ...
              className={`
                ...
                hover:bg-gray-50
                ${activeTab === item.id ? 'text-primary-start font-semibold' : 'text-gray-600'}
              `}
